export const products = [
  ...
  },
  {
    ...
    category: 'Dairy',
    imageEmoji: '🧈',
    ingredients: ['Pasteurised Cream (from Cow Milk)'],
    allergens: ['Milk'],
    safetyScore: 72,
    warnings: ['High saturated fat — limit intake if managing cholesterol'],
  ...
  },
  {
    ...
    category: 'Snacks',
    imageEmoji: '🥔',
    ingredients: ['Potatoes', 'Edible Vegetable Oil', 'Salt', 'Spice & Condiment'],
  ...
  },
  {
    ...
    imageEmoji: '🥭',
    ingredients: [
      'Mango pulp (45%)', 'Water', 'Sugar',
      'Acidity regulator (330)', 'Preservative (211)', 'Spices',
    ],
    allergens: ['None declared'],
    safetyScore: 60,
    warnings: [
  ...
  },
  {
    ...
    allergens: ['Milk'],
    safetyScore: 82,
    warnings: ['Very high saturated fat — limit if managing cardiovascular health'],
